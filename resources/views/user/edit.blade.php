...
{{--                                                   name="avatar"--}}
                                ...
                                <div class="file-image" data-field="avatar">
                                    <div class="img-container" data-prefix="/vendor/admin/themes/{{ _ADMIN_THEME_ }}/img/files/">
                                        <img data-src="@if($user->avatar){{ "https://dev-bloodhound.s3.amazonaws.com/profileimage/".($user->avatar) }}@else{{asset('img/no_avatar.png')}}@endif"
                                             src="@if($user->avatar){{ "https://dev-bloodhound.s3.amazonaws.com/profileimage/".('storage/'.$user->avatar) }}@else{{asset('img/no_avatar.png')}}@endif"
                                             alt="Avatar"
                                        />
                        ...
                        <a href="{{ route('users.index') }}" class="btn btn-brand btn-icon-sm btn-right">
